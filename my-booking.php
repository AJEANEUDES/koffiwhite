...
<title>GARAGE KOFFI WHITE | Ma Réservation </title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Ma Réservation </h5>
...
<li>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Annulée</a>
            <div class="clearfix"></div>
        </div>
