...
<title>GARAGE KOFFI WHITE | Mon Profile</title>
<!--Bootstrap -->
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Date d'enrégistrement -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Dernière mise à jour à -</label>
            ...
            <div class="form-group">
              <label class="control-label">Date de naisssance&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Sauvegarder les modifications <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
