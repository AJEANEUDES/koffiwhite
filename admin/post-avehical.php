...
<head>
	...
	<title> GARAGE KOFFI WHITE | Admin Post Vehicle</title>
...
<label class="col-sm-2 control-label">Number of kilometres<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="Numberofkilometres" class="form-control" required>
</div>
</div>
<div class="hr-dashed"></div>
