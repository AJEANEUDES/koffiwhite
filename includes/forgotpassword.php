...
echo "<script>alert('L'adresse électronique ou le numéro de téléphone portable n'est pas valide');</script>"; 
}
}
...
<div class="modal fade" id="forgotpassword">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Récupération du mot de passe</h3>
      </div>
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                ...
                <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Retour à la page de connexion</a></p>
              </div>
            </div>
          </div>
        </div>
