...
<title>GARAGE KOFFI WHITE | Poste des Témoignages</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Poste Témoignages</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Acceuil</a></li>
        <li>Poste Témoignages</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Poster Un Témoignage</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Témoignages</label>
              <textarea class="form-control white_bg" name="testimonial" rows="4" required=""></textarea>
            </div>
          
           
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Sauvegarder <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
