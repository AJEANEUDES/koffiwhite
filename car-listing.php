...
<title>GARAGE KOFFI WHITE | Listes des voitures</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Liste des Cars</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Acceuil</a></li>
        <li>Listes des Cars</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Listes</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Plus de Détails<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Trouver Votre Véhicule</h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="fueltype">
                  <option>Selectionnez le Type de Carburant</option>
...
<option value="CNG">CNG</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i>Rechercher Vehicule</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Voitures récemment inscrites</h5>
          </div>
