...
<title>GARAGE KOFFI WHITE | Détails Sur les Véhicules</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>$<?php echo htmlentities($result->PricePerDay);?> </p>Par Jour
          ...
          <ul>
            ...
            <li> <i class="fa fa-user-plus" aria-hidden="true"></i>
             ...
             <li> <i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->S);?></h5>
              <button class="btn" type="" name="send" name="" type="submit" > Ajouter au Panier  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span> </button>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Aperçu des véhicules </a></li>
...
<tr>
<td>Serrures de portes motorisées</td>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Reserve maintenant</a>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> sièges</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> modèles</li>
                <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->FuelType);?>Type de Carburant</li>
              </ul>
            </div>
          </div>
        </div>
