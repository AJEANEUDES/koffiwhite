...
<title>GARAGE KOFFI WHITE | Liste des Véhicules</title>
<!--Bootstrap -->
...
<option value="Petrol">Pétrole</option>
...
<option value="CNG">CNG</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Rechercher Véhicule</button>
              </div>
            </form>
          </div>
        </div>
